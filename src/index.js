...
import sktImage from "./textures/sky.jpg";
...
const skyTexture = textureLoader.load(sktImage);
...
gui
  ...
  .name("uColorOffset");
gui
  .add(material.uniforms.uColorMutiolier, "value")
  .min(0)
  .max(10)
  .step(0.001)
  .name("uColorMutiolier");
gui
